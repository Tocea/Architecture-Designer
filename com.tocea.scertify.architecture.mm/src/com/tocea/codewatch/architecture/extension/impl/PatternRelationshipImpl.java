...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Relationship</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tocea.codewatch.architecture.extension.impl.PatternRelationshipImpl#getReferenceName <em>Reference Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PatternRelationshipImpl extends RelationshipImpl implements PatternRelationship {
	/**
	 ...
	 * @generated
	 */
	protected PatternRelationshipImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ExtensionPackage.Literals.PATTERN_RELATIONSHIP;
	}
	...
	public void setReferenceName(String newReferenceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionPackage.PATTERN_RELATIONSHIP__REFERENCE_NAME, oldReferenceName, referenceName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtensionPackage.PATTERN_RELATIONSHIP__REFERENCE_NAME:
