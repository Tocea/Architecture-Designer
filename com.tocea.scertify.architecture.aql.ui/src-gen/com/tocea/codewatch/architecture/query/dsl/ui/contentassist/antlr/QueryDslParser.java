...
* generated by Xtext
*/
package com.tocea.codewatch.architecture.query.dsl.ui.contentassist.antlr;
...
public class QueryDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.tocea.codewatch.architecture.query.dsl.ui.contentassist.antlr.internal.InternalQueryDslParser createParser() {
		com.tocea.codewatch.architecture.query.dsl.ui.contentassist.antlr.internal.InternalQueryDslParser result = new com.tocea.codewatch.architecture.query.dsl.ui.contentassist.antlr.internal.InternalQueryDslParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getQueriesAccess().getGroup(), "rule__Queries__Group__0");
					put(grammarAccess.getQueriesAccess().getGroup_3(), "rule__Queries__Group_3__0");
					put(grammarAccess.getCustomQueryAccess().getGroup(), "rule__CustomQuery__Group__0");
					put(grammarAccess.getCustomQueryAccess().getGroup_3(), "rule__CustomQuery__Group_3__0");
					put(grammarAccess.getCustomQueryAccess().getGroup_3_1(), "rule__CustomQuery__Group_3_1__0");
					put(grammarAccess.getMetricQueryAccess().getGroup(), "rule__MetricQuery__Group__0");
					put(grammarAccess.getMetricQueryAccess().getGroup_3(), "rule__MetricQuery__Group_3__0");
					put(grammarAccess.getMetricQueryAccess().getGroup_3_1(), "rule__MetricQuery__Group_3_1__0");
					...
					put(grammarAccess.getQueriesAccess().getNameAssignment_1(), "rule__Queries__NameAssignment_1");
					put(grammarAccess.getQueriesAccess().getOutputAssignment_3_1(), "rule__Queries__OutputAssignment_3_1");
					put(grammarAccess.getQueriesAccess().getImportsAssignment_4(), "rule__Queries__ImportsAssignment_4");
					put(grammarAccess.getQueriesAccess().getQueriesAssignment_5(), "rule__Queries__QueriesAssignment_5");
					put(grammarAccess.getCustomQueryAccess().getNameAssignment_1(), "rule__CustomQuery__NameAssignment_1");
					put(grammarAccess.getCustomQueryAccess().getParametersAssignment_3_0(), "rule__CustomQuery__ParametersAssignment_3_0");
					put(grammarAccess.getCustomQueryAccess().getParametersAssignment_3_1_1(), "rule__CustomQuery__ParametersAssignment_3_1_1");
					put(grammarAccess.getCustomQueryAccess().getBodyAssignment_5(), "rule__CustomQuery__BodyAssignment_5");
					put(grammarAccess.getMetricQueryAccess().getNameAssignment_1(), "rule__MetricQuery__NameAssignment_1");
					put(grammarAccess.getMetricQueryAccess().getParametersAssignment_3_0(), "rule__MetricQuery__ParametersAssignment_3_0");
					put(grammarAccess.getMetricQueryAccess().getParametersAssignment_3_1_1(), "rule__MetricQuery__ParametersAssignment_3_1_1");
					put(grammarAccess.getMetricQueryAccess().getBodyAssignment_5(), "rule__MetricQuery__BodyAssignment_5");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			com.tocea.codewatch.architecture.query.dsl.ui.contentassist.antlr.internal.InternalQueryDslParser typedParser = (com.tocea.codewatch.architecture.query.dsl.ui.contentassist.antlr.internal.InternalQueryDslParser) parser;
			typedParser.entryRuleQueries();
