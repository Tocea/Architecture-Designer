...
/**
 * Manual modifications go to {com.tocea.scertify.architecture.xadl.ArchitectureDSLRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractArchitectureDSLRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "com/tocea/scertify/architecture/xadl/ArchitectureDSL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("com.tocea.scertify.architecture.xadl.ArchitectureDSL");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("xadl");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return com.tocea.scertify.architecture.xadl.services.ArchitectureDSLGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return com.tocea.scertify.architecture.xadl.serializer.ArchitectureDSLSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return com.tocea.scertify.architecture.xadl.serializer.ArchitectureDSLSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return com.tocea.scertify.architecture.xadl.parser.antlr.ArchitectureDSLParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return com.tocea.scertify.architecture.xadl.parser.antlr.ArchitectureDSLAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return com.tocea.scertify.architecture.xadl.parser.antlr.internal.InternalArchitectureDSLLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<com.tocea.scertify.architecture.xadl.parser.antlr.internal.InternalArchitectureDSLLexer> provideInternalArchitectureDSLLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(com.tocea.scertify.architecture.xadl.parser.antlr.internal.InternalArchitectureDSLLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(com.tocea.scertify.architecture.xadl.parser.antlr.internal.InternalArchitectureDSLLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends com.tocea.scertify.architecture.xadl.validation.ArchitectureDSLJavaValidator> bindArchitectureDSLJavaValidator() {
		return com.tocea.scertify.architecture.xadl.validation.ArchitectureDSLJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return com.tocea.scertify.architecture.xadl.formatting.ArchitectureDSLFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return com.tocea.scertify.architecture.xadl.jvmmodel.ArchitectureDSLJvmModelInferrer.class;
	}
