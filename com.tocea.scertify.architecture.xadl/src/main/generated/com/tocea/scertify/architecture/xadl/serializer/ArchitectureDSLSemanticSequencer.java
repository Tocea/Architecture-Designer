package com.tocea.scertify.architecture.xadl.serializer;
...
import com.tocea.scertify.architecture.xadl.architectureDSL.Constraint;
import com.tocea.scertify.architecture.xadl.architectureDSL.Datatype;
import com.tocea.scertify.architecture.xadl.architectureDSL.Enumeration;
import com.tocea.scertify.architecture.xadl.architectureDSL.EnumerationElement;
import com.tocea.scertify.architecture.xadl.architectureDSL.ExtensionConstraint;
import com.tocea.scertify.architecture.xadl.architectureDSL.Field;
import com.tocea.scertify.architecture.xadl.architectureDSL.Import;
...
import com.tocea.scertify.architecture.xadl.architectureDSL.PrimitiveRole;
import com.tocea.scertify.architecture.xadl.architectureDSL.Relationship;
import com.tocea.scertify.architecture.xadl.architectureDSL.RelationshipConjunctionConstraint;
import com.tocea.scertify.architecture.xadl.architectureDSL.Role;
import com.tocea.scertify.architecture.xadl.architectureDSL.TypeConstraint;
...
public class ArchitectureDSLSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private ArchitectureDSLGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ArchitectureDSLPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case ArchitectureDSLPackage.ARCHITECTURE_EXTENSION:
				if(context == grammarAccess.getArchitectureExtensionRule()) {
					sequence_ArchitectureExtension(context, (ArchitectureExtension) semanticObject); 
					return; 
				}
				else break;
			case ArchitectureDSLPackage.ARITY:
				if(context == grammarAccess.getArityRule()) {
					sequence_Arity(context, (Arity) semanticObject); 
					return; 
				}
				else break;
			...
			case ArchitectureDSLPackage.IMPORT:
				if(context == grammarAccess.getExtensionEntityRule() ||
			...
			case ArchitectureDSLPackage.PARAMETER:
				if(context == grammarAccess.getNamedEntityRule() ||
			...
			case ArchitectureDSLPackage.PATTERN:
				if(context == grammarAccess.getExtensionEntityRule() ||
				   context == grammarAccess.getNamedEntityRule() ||
				   context == grammarAccess.getParametrizedTypeRule() ||
			...
			case ArchitectureDSLPackage.PRIMITIVE_ROLE:
				if(context == grammarAccess.getExtensionEntityRule() ||
				   context == grammarAccess.getNamedEntityRule() ||
				   context == grammarAccess.getPrimitiveRoleRule() ||
				   context == grammarAccess.getReferencedTypeRule() ||
				   context == grammarAccess.getTypeRule()) {
					sequence_PrimitiveRole(context, (PrimitiveRole) semanticObject); 
					return; 
				}
				else break;
			...
			case ArchitectureDSLPackage.RELATIONSHIP_CONJUNCTION_CONSTRAINT:
				if(context == grammarAccess.getRelationshipConjunctionConstraintRule() ||
				   context == grammarAccess.getRelationshipConstraintRule()) {
					sequence_RelationshipConjunctionConstraint(context, (RelationshipConjunctionConstraint) semanticObject); 
					return; 
				}
				else break;
			...
			case ArchitectureDSLPackage.TYPE_CONSTRAINT:
				if(context == grammarAccess.getRelationshipPrimitiveConstraintRule() ||
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName entities+=ExtensionEntity*)
	 */
	protected void sequence_ArchitectureExtension(EObject context, ArchitectureExtension semanticObject) {
	 ...
	 *     (value=INT | unbound?='*')
	 */
	protected void sequence_Arity(EObject context, Arity semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Datatype(EObject context, Datatype semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ArchitectureDSLPackage.Literals.NAMED_ENTITY__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ArchitectureDSLPackage.Literals.NAMED_ENTITY__NAME));
			if(transientValues.isValueTransient(semanticObject, ArchitectureDSLPackage.Literals.DATATYPE__REFERENCE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ArchitectureDSLPackage.Literals.DATATYPE__REFERENCE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getDatatypeAccess().getReferenceJvmTypeReferenceParserRuleCall_1_0(), semanticObject.getReference());
		feeder.accept(grammarAccess.getDatatypeAccess().getNameIDTerminalRuleCall_3_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ArchitectureDSLPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ArchitectureDSLPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	/**
	 * Constraint:
	 *     (abstract?='abstract'? name=ID (parameters+=Parameter parameters+=Parameter*)? superPattern=TypeReference? fields+=Field*)
	 */
	 ...
	 */
	protected void sequence_PrimitiveRole(EObject context, PrimitiveRole semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ArchitectureDSLPackage.Literals.NAMED_ENTITY__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ArchitectureDSLPackage.Literals.NAMED_ENTITY__NAME));
			if(transientValues.isValueTransient(semanticObject, ArchitectureDSLPackage.Literals.PRIMITIVE_ROLE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ArchitectureDSLPackage.Literals.PRIMITIVE_ROLE__TYPE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getPrimitiveRoleAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getPrimitiveRoleAccess().getTypeJvmTypeReferenceParserRuleCall_3_0(), semanticObject.getType());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_RelationshipConjunctionConstraint(EObject context, RelationshipConjunctionConstraint semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
