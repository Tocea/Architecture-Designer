...
/**
 * Manual modifications go to {com.tocea.codewatch.architecture.query.dsl.QueryDslRuntimeModule}
 */
...
public abstract class AbstractQueryDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "com/tocea/codewatch/architecture/query/dsl/QueryDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("com.tocea.codewatch.architecture.query.dsl.QueryDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("aql");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return com.tocea.codewatch.architecture.query.dsl.services.QueryDslGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return com.tocea.codewatch.architecture.query.dsl.serializer.QueryDslSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return com.tocea.codewatch.architecture.query.dsl.serializer.QueryDslSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return com.tocea.codewatch.architecture.query.dsl.parser.antlr.QueryDslParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return com.tocea.codewatch.architecture.query.dsl.parser.antlr.QueryDslAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return com.tocea.codewatch.architecture.query.dsl.parser.antlr.internal.InternalQueryDslLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<com.tocea.codewatch.architecture.query.dsl.parser.antlr.internal.InternalQueryDslLexer> provideInternalQueryDslLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(com.tocea.codewatch.architecture.query.dsl.parser.antlr.internal.InternalQueryDslLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(com.tocea.codewatch.architecture.query.dsl.parser.antlr.internal.InternalQueryDslLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends com.tocea.codewatch.architecture.query.dsl.validation.QueryDslJavaValidator> bindQueryDslJavaValidator() {
		return com.tocea.codewatch.architecture.query.dsl.validation.QueryDslJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return com.tocea.codewatch.architecture.query.dsl.formatting.QueryDslFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return com.tocea.codewatch.architecture.query.dsl.jvmmodel.QueryDslJvmModelInferrer.class;
	}
