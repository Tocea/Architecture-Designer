...
(	otherlv_0='package' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getQueriesAccess().getPackageKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getQueriesAccess().getNameQualifiedNameParserRuleCall_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getQueriesAccess().getSemicolonKeyword_2());
    }
(	otherlv_3='output' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getQueriesAccess().getOutputKeyword_3_0());
    }
(
(
		lv_output_4_0=RULE_STRING
		{
			newLeafNode(lv_output_4_0, grammarAccess.getQueriesAccess().getOutputSTRINGTerminalRuleCall_3_1_0()); 
		}
		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getQueriesAccess().getSemicolonKeyword_3_2());
    }
)?(
(
		{ 
	        newCompositeNode(grammarAccess.getQueriesAccess().getImportsImportParserRuleCall_4_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getQueriesAccess().getQueriesQueryParserRuleCall_5_0()); 
	    }
...
(
    { 
        newCompositeNode(grammarAccess.getQueryAccess().getCustomQueryParserRuleCall_0()); 
    }
    this_CustomQuery_0=ruleCustomQuery
    { 
        $current = $this_CustomQuery_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getQueryAccess().getMetricQueryParserRuleCall_1()); 
    }
    this_MetricQuery_1=ruleMetricQuery
    { 
        $current = $this_MetricQuery_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleCustomQuery returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCustomQueryRule()); }
	 iv_ruleCustomQuery=ruleCustomQuery 
	 { $current=$iv_ruleCustomQuery.current; } 
	 EOF 
;

// Rule CustomQuery
ruleCustomQuery returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='query' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getCustomQueryAccess().getQueryKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
		{
			newLeafNode(lv_name_1_0, grammarAccess.getCustomQueryAccess().getNameIDTerminalRuleCall_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getCustomQueryRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getCustomQueryAccess().getLeftParenthesisKeyword_2());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getCustomQueryAccess().getParametersFullJvmFormalParameterParserRuleCall_3_0_0()); 
	    }
		lv_parameters_3_0=ruleFullJvmFormalParameter		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getCustomQueryRule());
	        }
       		add(
       			$current, 
       			"parameters",
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getCustomQueryAccess().getCommaKeyword_3_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getCustomQueryAccess().getParametersFullJvmFormalParameterParserRuleCall_3_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getCustomQueryAccess().getRightParenthesisKeyword_4());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getCustomQueryAccess().getBodyXBlockExpressionParserRuleCall_5_0()); 
	    }
...
entryRuleMetricQuery returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMetricQueryRule()); }
	 iv_ruleMetricQuery=ruleMetricQuery 
	 { $current=$iv_ruleMetricQuery.current; } 
	 EOF 
;

// Rule MetricQuery
ruleMetricQuery returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='metric' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMetricQueryAccess().getMetricKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
		{
			newLeafNode(lv_name_1_0, grammarAccess.getMetricQueryAccess().getNameIDTerminalRuleCall_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetricQueryRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getMetricQueryAccess().getLeftParenthesisKeyword_2());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getMetricQueryAccess().getParametersFullJvmFormalParameterParserRuleCall_3_0_0()); 
	    }
		lv_parameters_3_0=ruleFullJvmFormalParameter		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMetricQueryRule());
	        }
       		add(
       			$current, 
       			"parameters",
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getMetricQueryAccess().getCommaKeyword_3_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMetricQueryAccess().getParametersFullJvmFormalParameterParserRuleCall_3_1_1_0()); 
	    }
		lv_parameters_5_0=ruleFullJvmFormalParameter		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMetricQueryRule());
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getMetricQueryAccess().getRightParenthesisKeyword_4());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMetricQueryAccess().getBodyXBlockExpressionParserRuleCall_5_0()); 
	    }
		lv_body_7_0=ruleXBlockExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMetricQueryRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getImportAccess().getImportedNamespaceQIDParserRuleCall_1_0()); 
	    }
		lv_importedNamespace_1_0=ruleQID		{
	        if ($current==null) {
...
(
    { 
        newCompositeNode(grammarAccess.getQIDAccess().getQualifiedNameParserRuleCall_0()); 
    }
...
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getQIDAccess().getAsteriskKeyword_1_1()); 
    }
)?)
    ;
