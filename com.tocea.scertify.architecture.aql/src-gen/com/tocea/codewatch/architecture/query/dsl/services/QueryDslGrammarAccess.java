...
package com.tocea.codewatch.architecture.query.dsl.services;
...
public class QueryDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class QueriesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Queries");
		...
		//Queries:
		//	"package" name=QualifiedName ";" ("output" output=STRING ";")? imports+=Import* queries+=Query*;
	...
	public class QueryElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cCustomQueryParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cMetricQueryParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//CustomQuery
		public RuleCall getCustomQueryParserRuleCall_0() { return cCustomQueryParserRuleCall_0; }

		//MetricQuery
		public RuleCall getMetricQueryParserRuleCall_1() { return cMetricQueryParserRuleCall_1; }
	}

	public class CustomQueryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "CustomQuery");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MetricQueryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MetricQuery");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ImportElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cImportedNamespaceQIDParserRuleCall_1_0 = (RuleCall)cImportedNamespaceAssignment_1.eContents().get(0);
		private final Keyword cSemicolonKeyword_2 = (Keyword)cGroup.eContents().get(2);
		...
		//QID
		public RuleCall getImportedNamespaceQIDParserRuleCall_1_0() { return cImportedNamespaceQIDParserRuleCall_1_0; }
	...
	private QueriesElements pQueries;
	private QueryElements pQuery;
	private CustomQueryElements pCustomQuery;
	private MetricQueryElements pMetricQuery;
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("com.tocea.codewatch.architecture.query.dsl.QueryDsl".equals(grammar.getName())) {
				return grammar;
			}
	...
	public QueriesElements getQueriesAccess() {
		return (pQueries != null) ? pQueries : (pQueries = new QueriesElements());
	}
	...
	//	"query" name=ID "(" (parameters+=FullJvmFormalParameter ("," parameters+=FullJvmFormalParameter)*)? ")"
	//	body=XBlockExpression;
	public CustomQueryElements getCustomQueryAccess() {
		return (pCustomQuery != null) ? pCustomQuery : (pCustomQuery = new CustomQueryElements());
	}
	
	public ParserRule getCustomQueryRule() {
		return getCustomQueryAccess().getRule();
	}

	//MetricQuery:
	//	"metric" name=ID "(" (parameters+=FullJvmFormalParameter ("," parameters+=FullJvmFormalParameter)*)? ")"
	//	body=XBlockExpression;
	public MetricQueryElements getMetricQueryAccess() {
		return (pMetricQuery != null) ? pMetricQuery : (pMetricQuery = new MetricQueryElements());
	}
	
	public ParserRule getMetricQueryRule() {
		return getMetricQueryAccess().getRule();
	}
