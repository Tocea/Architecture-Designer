...
* generated by Xtext
*/
package com.tocea.scertify.architecture.xadl.ui.contentassist.antlr;
...
public class ArchitectureDSLParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.tocea.scertify.architecture.xadl.ui.contentassist.antlr.internal.InternalArchitectureDSLParser createParser() {
		com.tocea.scertify.architecture.xadl.ui.contentassist.antlr.internal.InternalArchitectureDSLParser result = new com.tocea.scertify.architecture.xadl.ui.contentassist.antlr.internal.InternalArchitectureDSLParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getExtensionEntityAccess().getAlternatives(), "rule__ExtensionEntity__Alternatives");
					...
					put(grammarAccess.getArityAccess().getAlternatives(), "rule__Arity__Alternatives");
					put(grammarAccess.getTypeConstraintAccess().getAlternatives_1(), "rule__TypeConstraint__Alternatives_1");
					put(grammarAccess.getTypeConstraintAccess().getAlternatives_3(), "rule__TypeConstraint__Alternatives_3");
					put(grammarAccess.getNamedEntityAccess().getAlternatives(), "rule__NamedEntity__Alternatives");
					put(grammarAccess.getReferencedTypeAccess().getAlternatives(), "rule__ReferencedType__Alternatives");
					...
					put(grammarAccess.getPatternAccess().getGroup_3_2(), "rule__Pattern__Group_3_2__0");
					put(grammarAccess.getPatternAccess().getGroup_4(), "rule__Pattern__Group_4__0");
					put(grammarAccess.getPatternAccess().getGroup_5_0(), "rule__Pattern__Group_5_0__0");
					put(grammarAccess.getPatternAccess().getGroup_5_0_1(), "rule__Pattern__Group_5_0_1__0");
					put(grammarAccess.getPrimitiveRoleAccess().getGroup(), "rule__PrimitiveRole__Group__0");
					...
					put(grammarAccess.getRoleAccess().getGroup_4_0(), "rule__Role__Group_4_0__0");
					...
					put(grammarAccess.getRelationshipAccess().getGroup_4_2(), "rule__Relationship__Group_4_2__0");
					put(grammarAccess.getRelationshipAccess().getGroup_5_0(), "rule__Relationship__Group_5_0__0");
					put(grammarAccess.getRelationshipAccess().getGroup_5_0_1(), "rule__Relationship__Group_5_0_1__0");
					put(grammarAccess.getFieldAccess().getGroup(), "rule__Field__Group__0");
					put(grammarAccess.getFieldAccess().getGroup_4_1(), "rule__Field__Group_4_1__0");
					put(grammarAccess.getFieldAccess().getGroup_4_1_2(), "rule__Field__Group_4_1_2__0");
					...
					put(grammarAccess.getRelationshipConjunctionConstraintAccess().getGroup(), "rule__RelationshipConjunctionConstraint__Group__0");
					put(grammarAccess.getRelationshipConjunctionConstraintAccess().getGroup_1(), "rule__RelationshipConjunctionConstraint__Group_1__0");
					...
					put(grammarAccess.getArchitectureExtensionAccess().getNameAssignment_1(), "rule__ArchitectureExtension__NameAssignment_1");
					put(grammarAccess.getArchitectureExtensionAccess().getEntitiesAssignment_2(), "rule__ArchitectureExtension__EntitiesAssignment_2");
					put(grammarAccess.getDatatypeAccess().getReferenceAssignment_1(), "rule__Datatype__ReferenceAssignment_1");
					put(grammarAccess.getDatatypeAccess().getNameAssignment_3(), "rule__Datatype__NameAssignment_3");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getPatternAccess().getAbstractAssignment_0(), "rule__Pattern__AbstractAssignment_0");
					put(grammarAccess.getPatternAccess().getNameAssignment_2(), "rule__Pattern__NameAssignment_2");
					put(grammarAccess.getPatternAccess().getParametersAssignment_3_1(), "rule__Pattern__ParametersAssignment_3_1");
					put(grammarAccess.getPatternAccess().getParametersAssignment_3_2_1(), "rule__Pattern__ParametersAssignment_3_2_1");
					put(grammarAccess.getPatternAccess().getSuperPatternAssignment_4_1(), "rule__Pattern__SuperPatternAssignment_4_1");
					...
					put(grammarAccess.getRelationshipAccess().getConstraintsAssignment_4_1(), "rule__Relationship__ConstraintsAssignment_4_1");
					put(grammarAccess.getRelationshipAccess().getConstraintsAssignment_4_2_1(), "rule__Relationship__ConstraintsAssignment_4_2_1");
					put(grammarAccess.getRelationshipAccess().getFieldsAssignment_5_0_1_0(), "rule__Relationship__FieldsAssignment_5_0_1_0");
					put(grammarAccess.getParameterAccess().getNameAssignment(), "rule__Parameter__NameAssignment");
					put(grammarAccess.getFieldAccess().getMandatoryAssignment_0(), "rule__Field__MandatoryAssignment_0");
					...
					put(grammarAccess.getFieldAccess().getManyAssignment_4_0(), "rule__Field__ManyAssignment_4_0");
					put(grammarAccess.getFieldAccess().getLbAssignment_4_1_1(), "rule__Field__LbAssignment_4_1_1");
					put(grammarAccess.getFieldAccess().getUbAssignment_4_1_2_1(), "rule__Field__UbAssignment_4_1_2_1");
					put(grammarAccess.getArityAccess().getValueAssignment_0(), "rule__Arity__ValueAssignment_0");
					put(grammarAccess.getArityAccess().getUnboundAssignment_1(), "rule__Arity__UnboundAssignment_1");
					put(grammarAccess.getTypeReferenceAccess().getReferenceAssignment_0(), "rule__TypeReference__ReferenceAssignment_0");
					put(grammarAccess.getTypeReferenceAccess().getParametersAssignment_1_1(), "rule__TypeReference__ParametersAssignment_1_1");
					put(grammarAccess.getTypeReferenceAccess().getParametersAssignment_1_2_1(), "rule__TypeReference__ParametersAssignment_1_2_1");
					put(grammarAccess.getRelationshipConjunctionConstraintAccess().getConstraintsAssignment_0(), "rule__RelationshipConjunctionConstraint__ConstraintsAssignment_0");
					put(grammarAccess.getRelationshipConjunctionConstraintAccess().getConstraintsAssignment_1_1(), "rule__RelationshipConjunctionConstraint__ConstraintsAssignment_1_1");
					put(grammarAccess.getTypeConstraintAccess().getSourceAssignment_1_0(), "rule__TypeConstraint__SourceAssignment_1_0");
					put(grammarAccess.getTypeConstraintAccess().getTargetAssignment_3_0(), "rule__TypeConstraint__TargetAssignment_3_0");
					put(grammarAccess.getEnumerationAccess().getNameAssignment_1(), "rule__Enumeration__NameAssignment_1");
					put(grammarAccess.getEnumerationAccess().getElementsAssignment_3_0(), "rule__Enumeration__ElementsAssignment_3_0");
					put(grammarAccess.getEnumerationElementAccess().getNameAssignment(), "rule__EnumerationElement__NameAssignment");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			com.tocea.scertify.architecture.xadl.ui.contentassist.antlr.internal.InternalArchitectureDSLParser typedParser = (com.tocea.scertify.architecture.xadl.ui.contentassist.antlr.internal.InternalArchitectureDSLParser) parser;
			typedParser.entryRuleArchitectureExtension();
